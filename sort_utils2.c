...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/24 13:53:35 by afelten           #+#    #+#             */
/*   Updated: 2022/05/24 14:37:13 by afelten          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_min_or_max_to_top(t_stack **b)
{
	...
	size = ft_lstsize(*b);
	if (i_min > size / 2 && ((i_max > size / 2 && i_min > i_max)
			|| (i_max <= size / 2 && i_max > size - i_min)))
		run_ncommand(0, b, "rrb", size - i_min);
	else if (i_max > size / 2 && ((i_min > size / 2 && i_min < i_max)
			|| (i_min <= size / 2 && i_min > size - i_max)))
		run_ncommand(0, b, "rrb", size - i_max);
	else if (i_min <= size / 2 && ((i_max <= size / 2 && i_min < i_max)
			|| (i_max > size / 2 && i_min < size - i_max)))
